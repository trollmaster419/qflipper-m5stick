...
Image {
    ...
    visible: opacity > 0
    source: "image://themed/" + Theme.palette + "/assets/gfx/images/flipper.svg"
    ...
    Image {
        ...
        source: "image://themed/" + Theme.palette + "/assets/gfx/images/" +
                (deviceState && deviceState.isRecoveryMode ? "recovery.svg" :
                 Backend.backendState === ApplicationBackend.Finished ? "success.svg" :
                                                                        "default.svg")
