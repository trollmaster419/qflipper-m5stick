...
Rectangle {
    ...
    Canvas {
        ...
        // Repaint when the accent palette changes so the grid follows the theme.
        property color lineColor: Theme.color.mediumorange1
        ...
        onPaint: {
            ...
            ctx.reset();
            ctx.strokeStyle = gridCanvas.lineColor;
            ctx.lineWidth = 2;
